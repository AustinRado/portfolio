      ...
      <div className='flex justify-center mt-9 pt-[40px]'>
        <div className='col-span-7 place-self-center sm:text-left'>
            ...
            <p className='text-sm sm:text-lg mb-6 lg:text-xl text-center'>
              I am a <span className='font-bold'>full stack developer</span> with a passion for problem-solving. I have experience in building interactive and responsive websites. My focus is React(Next.js) framework, NodeJs, APIs, AWS and Python (Flask, Django). I am always open to collaborations.
            </p>
