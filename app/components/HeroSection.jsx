      ...
      <div className='flex justify-center mt-9 pt-[40px]'>
        <div className='col-span-7 place-self-center sm:text-left'>
            ...
            <p className='text-white text-base sm:text-lg mb-6 lg:text-xl text-center'>
              I am a <span>full stack developer</span> with 3 years of experience. I enjoy problem-solving, building applications and websites. My focus is React(Next.js), NodeJs, APIs, AWS and Python (Flusk, Django). I am always open to new experiences and opportunities.
            </p>
